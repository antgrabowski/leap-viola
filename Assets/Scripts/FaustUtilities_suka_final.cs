...
*/
namespace FaustUtilities_suka_final {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_suka_final))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_suka_final _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"suka_final\",	\"filename\": \"suka_final.dsp\",	\"version\": \"2.40.12\",	\"compile_options\": \"-lang cpp -es 1 -mcd 16 -uim -single -ftz 0\",	\"include_pathnames\": [\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/tmp/sessions/36396313C87D5B523FEED02AF205E1F0A87C34E7/unity/windows64/.\"],	\"inputs\": 0,	\"outputs\": 2,	\"meta\": [ 		{ \"basics_lib_name\": \"Faust Basic Element Library\" },		{ \"basics_lib_version\": \"0.8\" },		{ \"compile_options\": \"-single -scal -I libraries/ -I project/ -lang wasm\" },		{ \"delays_lib_fdelay4_author\": \"Julius O. Smith III\" },		{ \"delays_lib_fdelayltv_author\": \"Julius O. Smith III\" },		{ \"delays_lib_name\": \"Faust Delay Library\" },		{ \"delays_lib_version\": \"0.1\" },		{ \"envelopes_lib_ar_author\": \"Yann Orlarey, Stéphane Letz\" },		{ \"envelopes_lib_asr_author\": \"Yann Orlarey, Stéphane Letz\" },		{ \"envelopes_lib_author\": \"GRAME\" },		{ \"envelopes_lib_copyright\": \"GRAME\" },		{ \"envelopes_lib_license\": \"LGPL with exception\" },		{ \"envelopes_lib_name\": \"Faust Envelope Library\" },		{ \"envelopes_lib_version\": \"0.2\" },		{ \"filename\": \"suka_final.dsp\" },		{ \"filters_lib_fir_author\": \"Julius O. Smith III\" },		{ \"filters_lib_fir_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_fir_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_iir_author\": \"Julius O. Smith III\" },		{ \"filters_lib_iir_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_iir_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_lowpass0_highpass1\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_name\": \"Faust Filters Library\" },		{ \"filters_lib_resonbp_author\": \"Julius O. Smith III\" },		{ \"filters_lib_resonbp_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_resonbp_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_tf2_author\": \"Julius O. Smith III\" },		{ \"filters_lib_tf2_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_tf2_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_tf2s_author\": \"Julius O. Smith III\" },		{ \"filters_lib_tf2s_copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_tf2s_license\": \"MIT-style STK-4.3 license\" },		{ \"filters_lib_version\": \"0.3\" },		{ \"library_path0\": \"/libraries/stdfaust.lib\" },		{ \"library_path1\": \"/libraries/signals.lib\" },		{ \"library_path10\": \"/libraries/filters.lib\" },		{ \"library_path2\": \"/libraries/maths.lib\" },		{ \"library_path3\": \"/libraries/platform.lib\" },		{ \"library_path4\": \"/libraries/envelopes.lib\" },		{ \"library_path5\": \"/libraries/basics.lib\" },		{ \"library_path6\": \"/libraries/oscillators.lib\" },		{ \"library_path7\": \"/libraries/physmodels.lib\" },		{ \"library_path8\": \"/libraries/routes.lib\" },		{ \"library_path9\": \"/libraries/delays.lib\" },		{ \"maths_lib_author\": \"GRAME\" },		{ \"maths_lib_copyright\": \"GRAME\" },		{ \"maths_lib_license\": \"LGPL with exception\" },		{ \"maths_lib_name\": \"Faust Math Library\" },		{ \"maths_lib_version\": \"2.5\" },		{ \"name\": \"suka_final\" },		{ \"oscillators_lib_name\": \"Faust Oscillator Library\" },		{ \"oscillators_lib_version\": \"0.3\" },		{ \"physmodels_lib_name\": \"Faust Physical Models Library\" },		{ \"physmodels_lib_version\": \"0.1\" },		{ \"platform_lib_name\": \"Generic Platform Library\" },		{ \"platform_lib_version\": \"0.2\" },		{ \"routes_lib_name\": \"Faust Signal Routing Library\" },		{ \"routes_lib_version\": \"0.2\" },		{ \"signals_lib_name\": \"Faust Signal Routing Library\" },		{ \"signals_lib_version\": \"0.3\" },		{ \"version\": \"2.41.1\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"suka_final\",			\"items\": [ 				{					\"type\": \"hslider\",					\"label\": \"Bowing frequency\",					\"shortname\": \"Bowing_frequency\",					\"address\": \"/suka_final/Bowing_frequency\",					\"init\": 3,					\"min\": 0,					\"max\": 10,					\"step\": 0.01				},				{					\"type\": \"hslider\",					\"label\": \"Possition\",					\"shortname\": \"Possition\",					\"address\": \"/suka_final/Possition\",					\"init\": 0.2,					\"min\": 0,					\"max\": 1,					\"step\": 0.01				},				{					\"type\": \"hslider\",					\"label\": \"Resonance Oscilation\",					\"shortname\": \"Resonance_Oscilation\",					\"address\": \"/suka_final/Resonance_Oscilation\",					\"init\": 0.5,					\"min\": 0,					\"max\": 1,					\"step\": 0.01				},				{					\"type\": \"hslider\",					\"label\": \"Velocity attack\",					\"shortname\": \"Velocity_attack\",					\"address\": \"/suka_final/Velocity_attack\",					\"init\": 1,					\"min\": 0.1,					\"max\": 5,					\"step\": 0.01				},				{					\"type\": \"hslider\",					\"label\": \"freq\",					\"shortname\": \"freq\",					\"address\": \"/suka_final/freq\",					\"init\": 440,					\"min\": 300,					\"max\": 1000,					\"step\": 0.1				},				{					\"type\": \"hslider\",					\"label\": \"gain\",					\"shortname\": \"gain\",					\"address\": \"/suka_final/gain\",					\"init\": 0,					\"min\": -96,					\"max\": 0,					\"step\": 0.1				},				{					\"type\": \"hslider\",					\"label\": \"preasure\",					\"shortname\": \"preasure\",					\"address\": \"/suka_final/preasure\",					\"init\": 0.2,					\"min\": 0,					\"max\": 1,					\"step\": 0.01				}			]		}	]}";
			...
			_dsp = (FaustPlugin_suka_final) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
		...
		const string _dllName = "libFaustPlugin_suka_final";
		#elif UNITY_IOS
		const string _dllName = "__Internal";
		#elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
		const string _dllName = "FaustPlugin_suka_final";
		#else
